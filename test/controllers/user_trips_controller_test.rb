...
class UserTripsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_trip" do
    assert_difference("UserTrip.count") do
      post user_trips_url, params: { user_trip: { trip_id: @user_trip.trip_id, user_id: @user_trip.user_id } }
    end
  ...
  test "should update user_trip" do
    patch user_trip_url(@user_trip), params: { user_trip: { trip_id: @user_trip.trip_id, user_id: @user_trip.user_id } }
